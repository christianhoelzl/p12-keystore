...
define_oids! {
    ...
    { SHA224_OID, "2.16.840.1.101.3.4.2.4", "SHA-224 hash algorithm" },
    { SHA256_OID, "2.16.840.1.101.3.4.2.1", "SHA-256 hash algorithm" },
    { SHA384_OID, "2.16.840.1.101.3.4.2.2", "SHA-384 hash algorithm" },
    { SHA512_OID, "2.16.840.1.101.3.4.2.3", "SHA-512 hash algorithm" },
    { SHA512_224_OID, "2.16.840.1.101.3.4.2.5", "SHA-512/224 hash algorithm" },
    { SHA512_256_OID, "2.16.840.1.101.3.4.2.6", "SHA-512/256 hash algorithm" },
    { PBKDF2_OID, "1.2.840.113549.1.5.12", "PBKDF2 key derivation function" },
    { PBMAC1_OID, "1.2.840.113549.1.5.14", "PBMAC1 password-based MAC" },
    { HMAC_SHA512_224_KEY_OID, "1.2.840.113549.2.12", "HMAC with SHA-512/224" },
    { HMAC_SHA512_256_KEY_OID, "1.2.840.113549.2.13", "HMAC with SHA-512/256" },
    { CERT_TYPE_X509_CERTIFICATE_OID, "1.2.840.113549.1.9.22.1", "X.509 certificate type" },
    { PKCS_12_KEY_BAG_OID, "1.2.840.113549.1.12.10.1.1", "PKCS#12 PKCS#8 key bag" },
    { PKCS_12_PKCS8_SHROUDED_KEY_BAG_OID, "1.2.840.113549.1.12.10.1.2", "PKCS#12 PKCS#8 shrouded key bag" },
